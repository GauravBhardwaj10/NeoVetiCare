...
PDFView pdf2;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.report) {
                    Toast.makeText(layout2.this, "Report this app:", Toast.LENGTH_SHORT).show();
                    showOptionDialog();}
                if (item.getItemId() == R.id.contact) {
                    Intent contact = new Intent(layout2.this, ContactActivity.class);
    ...
    public void showOptionDialog() {
        ...
        builder.setSingleChoiceItems(genders, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                Toast.makeText(layout2.this, "your" + selectedGender, Toast.LENGTH_LONG).show();
    ...
    public void go()
    {
        ...
        Toast.makeText(layout2.this, "You Report: " + selectedGender, Toast.LENGTH_LONG).show();
