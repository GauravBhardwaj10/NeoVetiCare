...
PDFView pdf3;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.report) {
                    Toast.makeText(layout3.this, "Report this app:", Toast.LENGTH_SHORT).show();
                    showOptionDialog();}
                if (item.getItemId() == R.id.contact) {
                    Intent contact = new Intent(layout3.this, ContactActivity.class);
    ...
    public void showOptionDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(layout3.this);
        builder.setTitle("Choose");
        builder.setSingleChoiceItems(genders, 0, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int which) {
                selectedGender = genders[which];
                Toast.makeText(layout3.this, "your" + selectedGender, Toast.LENGTH_LONG).show();
    ...
    public void go()
    {
        ...
        Toast.makeText(layout3.this, "You Report: " + selectedGender, Toast.LENGTH_LONG).show();
